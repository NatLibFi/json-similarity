...
function factory(objectCompare, jsonpath, jjv, jjve, schema)
{
	...
	return {
		...
		var value1 = copyValue(jsonpath.query(obj1, test.path));
		var value2 = copyValue(jsonpath.query(obj2, test.path));
		
		if (Array.isArray(value1) === true && Array.isArray(value2) === true && value1.length === 1 && value2.length === 1) {
		    value1 = value1.shift();
		    value2 = value2.shift();
		}
		...
		if (value1 === undefined && value2 === undefined) {
		    return true;
		} else if (skip_missing && (value1 === undefined || value2 === undefined)) {
		    return true;
		} else {
